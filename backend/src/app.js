...
io.on('connection', (socket) => {
  ...
  // Here we are listening for the client to send the keyword 'thisIsAKeyword' 
  // After the socket receives the keyword it prints a success statement and prints the arguments
